...
namespace NaniyoInfo
{
    ...
    // https://learn.microsoft.com/ko-kr/dotnet/api/system.security.cryptography.x509certificates.x509certificate2?view=netframework-4.6.2
    class X509CertEncrypt
    {
